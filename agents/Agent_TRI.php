        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
			 ...
			 <?php require('../pages/navbar.php');?>
                ...
                <h6 class="m-0 font-weight-bold text-primary">Bureau De TRI</h6>
                <div class="card-body">
...
echo '<td>';
echo '  <a class="btn btn-info btn-circle btn-sm"  href="../ordonnancer_Facture.php?id= ' . $row['id'] . '  " ><i class="fas fa-info-circle"></i></a> ';
echo '</td>';

echo '<td>';
echo '<a class="btn btn-primary btn-circle btn-sm"" href="reclamtion.php?id= ' . $row['id'] . ' "  id="messagesDropdown" role="button"><i class="fas fa-envelope fa-fw"></i></a> ';
echo '</td>';
