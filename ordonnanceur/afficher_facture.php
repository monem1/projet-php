...
<body id="page-top">
    ...
    <div class="container-fluid"> 
                ...
                <h6 class="m-0 font-weight-bold text-primary">Bienvenue <?php echo $_SESSION['login']; ?> </h6>
                <div class="card-body">
                <div class="table-responsive">
                  ...
                  <tbody>
<?php 
$sql = "SELECT * FROM factures  WHERE Ordonnanceur='$ordonnanceur' AND Etape LIKE 'O%'  "  ;
